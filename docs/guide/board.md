...
<img style="max-width:500px;width:100%" src="../images/board/board-3.png" alt="results bot"/>
...
<img style="max-width:500px;width:100%" src="../images/custom-board-3.png" alt="results bot"/>
